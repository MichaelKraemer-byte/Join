 ...
 * 
 * @param {string} contact - The contact parameter containing the name from which initials will be extracted.
 * @returns {string} The initials extracted from the first letters of the first and last name, converted to uppercase.
 */
